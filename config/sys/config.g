...
;M665 R218 L421.8 B150 H300 I J200;          ; Set delta radius
M669 K3;
M665 L421.8 R218 B150 H300;          ; Set delta radius, diagonal rod length, printable radius and homed height. I indicate Inverse delta kineamtics (moving plate). J is the safe height.
...
M106 P1 T45 H4 C"Cold" ; fan1 is watching H4 and is on when temp is above 15° and is called Cold

; Fans
M950 F0 C"!out4" Q2500                        ; create fan 0 on pin out4 and set its frequency REFROID Carte mère
M106 P0 S1                                    ; set fan 0 value. Thermostatic control is turned off
...
; Tools
M563 P1 S"Extruder" D0 H1:2 F1              ; define tool & named Extruder, using drive 3, heaters 1/2, and Fan 1
