...
M584 X0.0 Y0.1 Z0.2 E1.0:1.2                 ; set drive mapping 
...
; Endstops
M574 X1 S1 P"io5.in"   ; X min active high endstop switch
M574 Y1 S1 P"io8.in"   ; Y min active high endstop switch
M574 Z1 S1 P"io6.in"   ; Z min active high endstop switch
